export default {
  ...
  blca: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "25.00",
        description:
          "Covers up to two people on a single motorcycle and is valid for seven calendar days.",
      ...
      },
      {
        cost: "30.00",
        description:
          "Bus with 6 or less passenger seating capacity: $25 plus $7.00 per person",
        title: "Entrance Fee - commercial bus",
      },
    ],
    entrancePasses: [
      {
        cost: "55.00",
        description:
          "This pass admits the permit holder and all accompanying passengers in a single, private, noncommercial vehicle to the park. It is valid for 12 months from date of purchase and covers entry fees only.",
    ...
    operatingHours: [
      {
        exceptions: [],
        description:
          "The park is open 24 hours a day, every day, and no entry reservation is needed. The South Rim Road is open to vehicles from mid-April to mid-November. In winter, the South Rim Road is open to Gunnison Point. The remainder of the road is closed to vehicles, but open to cross country skiing and snowshoeing.\n\nSouth Rim Visitor Center hours are listed on the Basic Information page.",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
      ...
      },
      {
        ...
        description:
          "The park is open 24 hours a day, but the North Rim Road and ranger station are closed in winter and early spring. The road typically closes late November and reopens mid-April.",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
  ...
  brca: {
    ...
    entranceFees: [
      ...
      },
      {
        ...
        title:
          "Road-based Commercial Tour (vehicle 7-15 seats, regardless of occupancy)",
      },
      {
        cost: "60.00",
        description: "Flat fee.",
        title:
          "Road-based Commercial Tour (vehicle 16-25 seats, regardless of occupancy)",
      },
      {
        cost: "150.00",
        description: "Flat fee.",
        title:
          "Road-based Commercial Tour (vehicle 26 or more seats, regardless of occupancy)",
      },
    ],
    entrancePasses: [
      {
  ...
  care: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "15.00",
        description:
          "The entrance fee for Capitol Reef National Park is paid into a self-serve tube at the beginning of the Scenic Drive, just past the campground. The cost includes all on a single motorcycle. America the Beautiful Interagency passes cover this entrance fee.",
      ...
      },
      {
        cost: "100.00",
        description:
          "Buses and commercial vehicles are based on vehicle size/occupants. This fee can be paid at the visitor center.",
        title:
          "Capitol Reef Entrance Fee - Commercial vehicles with a seating capacity of 26 seats or greater",
      },
      {
        cost: "40.00",
        description:
          "Buses and commercial vehicles are based on vehicle size/occupants. This fee can be paid at the visitor center.",
        title:
          "Capitol Reef Entrance Fee - Commercial vehicles with a seating capacity of 7-25 seats",
      },
      {
        cost: "30.00",
        description:
          "Buses and commercial vehicles are based on vehicle size/occupants. This fee can be paid at the visitor center.",
        title:
          "Capitol Reef Entrance Fee - Commercial vehicles with a seating capacity of 1-6 seats",
      },
    ],
    entrancePasses: [
      {
  ...
  crla: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "25.00",
        description:
          "Admits one or two passengers on a private, non-commercial motorcycle. Valid for 7 consecutive days.",
        title: "Motorcycle - Summer (May 22 - October 31)",
      },
      {
        cost: "15.00",
        description:
          "Admits one or two passengers on a private, non-commercial motorcycle. Valid for 7 consecutive days.  Valid for 7 consecutive days.",
        title: "Motorcycle - Winter (November 1 - May 21)",
      },
      {
        cost: "15.00",
        description:
          "Admits one individual with no car (bicyclist, hiker, pedestrian). Youth 15 and under are admitted free of charge. Valid for 7 consecutive days.",
        title: "Bicyclist, Hiker, Pedestrian with no car",
      },
      {
        cost: "30.00",
        description:
          "Commercial vehicles with a capacity of 1 to 6 passengers are required to pay a $30 entrance fee, plus a $15 per passenger fee.\n\nThe entrance fee structure for commercial vehicles visiting national parks is based on the capacity of the vehicle you arrive in, not the\nnumber of passengers. This fee is valid for 7 consecutive days with the same company and the same passengers.",
    ...
    entrancePasses: [
      {
        cost: "55.00",
        description:
          "Valid only at Crater Lake National Park and Lava Beds National Monument. The Crater Lake annual pass is good for one year from the issue month. It admits the pass owner and accompanying passengers in a single, private, noncommercial vehicle or pass owner and three persons when entry is by other means.",
  ...
  dena: {
    ...
    entranceFees: [
      {
        cost: "15.00",
        description: "Admits one individual, 16 years and up.",
        title: "Denali Individual Weekly Pass",
      },
      {
        cost: "45.00",
        description:
  ...
  ever: {
    ...
    entranceFees: [
      ...
      },
      {
        ...
        title:
          "Everglades National Park Entrance Fee- Per Person/Cyclist/Paddlecraft",
      },
      {
        cost: "25.00",
        description:
      ...
      },
      {
        cost: "200.00",
        description:
          "Entrance fees to the Everglades National Park are charged based on the seating capacity of the vehicle.\n\nMotorcoach (26 or more passengers)",
  ...
  jeff: {
    ...
    entranceFees: [
      ...
      },
      {
        ...
        title: "Museum under the Gateway Arch",
      },
      {
        cost: "7.00",
        description:
    ...
    operatingHours: [
      ...
      },
      {
        exceptions: [],
        description:
          "The Old Courthouse is closed for renovations. The National Park Service (NPS) has announced the Old Courthouse at Gateway Arch National Park will undergo renovations beginning in late 2021. The renovations are part of the final component of the $380-million CityArchRiver project, which has resulted in the revitalization of the Gateway Arch park grounds, Arch Visitor Center and Museum at the Gateway Arch and is the largest public-private partnership in the history of the National Park Service.",
        standardHours: {
          wednesday: "Closed",
          monday: "Closed",
          thursday: "Closed",
    ...
    operatingHours: [
      {
        exceptions: [],
        description:
          "There are no entrance gates at Glacier Bay National Park, so we are technically open 24-hours a day; however,  services may be extremely limited depending on the time of your visit.\nThe main visitor season is from late-May through early-September with the peak being the month of July. Check the VISITOR CENTERS tab below to see hours for specific facilities, and read the exceptions that detail seasonal changes in hours.",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
      ...
      },
      {
        exceptions: [
          {
            ...
            name: "Closed for Winter Season",
            endDate: "2023-06-01",
          },
        ],
        description:
          "Located on the second floor of Glacier Bay Lodge in Bartlett Cove, 10 miles from Gustavus.\nStaffed daily in summer with park rangers. Stop by for exhibits, park information, trip planning, bookstore, reading area, hydrophone kiosk, interpretive programs, park films, brochures, and much more.\n\nThe Glacier Bay Lodge is open 6 AM to 10 PM.",
        standardHours: {
        ...
        name: "Glacier Bay Visitor Center Desk Hours",
      },
      {
        exceptions: [
          {
        ...
        name: "Visitor Information Station (VIS) Hours",
      },
      {
        exceptions: [],
        description:
          "Xunaa Shuká Hít (Huna Tribal House) is open on a limited basis during the summer season (Memorial Day to Labor Day) for scheduled ranger programs.\n\nIn 2016, after almost 20 years of planning, NPS and the Hoonah Indian Association dedicated Xunaa Shuká Hít (Huna Tribal House), a traditional Tlingit structure designed to symbolically anchor the Huna Tlingit in Glacier Bay, their ancestral homeland.\n\n***NOTE: Building closed from 5 PM to 6:30 PM for the dinner hour.***",
        standardHours: {
          wednesday: "Closed",
          monday: "Closed",
          thursday: "Closed",
        ...
        name: "Xunaa Shuká Hít (Huna Tribal House) Hours",
      },
    ],
    weatherInfo:
    ...
    entranceFees: [
      {
        ...
        title: "Entrance Fee by private vehicle - 7 day permit (summer)",
      },
      {
        cost: "20.00",
        description:
        ...
        title: "Entrance Fee by single entry (summer)",
      },
      {
        cost: "30.00",
        description:
      ...
      },
      {
        cost: "2.00",
        description:
          "Glacier National Park has instituted an online vehicle reservation system for the Going-to-the-Sun Road corridor between the park's Camas, West, and St. Mary Entrances from May 27 to September 11, 2022.",
        title: "Going-to-the-Sun Road Entry Reservation Ticket",
      },
      {
        cost: "25.00",
        description:
          "This is a entrance fee for all persons traveling in a single, private, non-commercial vehicle (car/truck/van). The permit is non-transferable. Visitors can enter the park at any time, if the entrance station is not staffed, a self-registration area is available for purchasing a 7-day park permit.\n\nThe winter rate is charged from November 1 to April 30.",
        title: "Entrance Fee by private vehicle - 7 day permit (winter)",
      },
      {
        cost: "15.00",
        description:
          "This is a per person entrance fee for a visitor traveling on foot, bicycle, or for individuals traveling together in a vehicle as a non-commercial, organized group. The permit is non-transferable.\n\nThe winter rate is charged from November 1 to April 30.",
        title: "Entrance fee by single entry (winter)",
      },
      {
        cost: "20.00",
        description:
          "This is a per motorcycle entrance fee. The permit is non-transferable.\n\nThe winter rate is charged from November 1 to April 30.",
        title: "Entry Fee by motorcycle (winter)",
      },
    ],
    entrancePasses: [
      {
      ...
      },
      {
        ...
        title: "America the Beautiful Senior Lifetime Pass",
      },
      {
        cost: "20.00",
        description:
          "Available for U.S. citizens or permanent residents age 62 or over. Applicants must provide documentation of age and residency or citizenship.\nThis pass is only valid for one year. Four Annual Senior Passes may be exchanged for a free Lifetime Senior Pass.",
        title: "America the Beautiful Senior Annual Pass",
      },
      {
        cost: "0.00",
        description:
          "Free to U.S. 4th Graders (including home-schooled and free-choice learners 10 years of age).\nValid for the duration of the 4th grade school year (September - August).\nStudents must have a paper voucher printed from the Every Kid Outdoors to obtain the Annual 4th Grade Pass. Digital versions of the voucher (such as smart phones or tablets) will not be accepted.",
        title: "America the Beautiful Every Kid Outdoors Pass",
      },
      {
        cost: "0.00",
        description:
        ...
        title: "America the Beautiful Access Pass",
      },
      {
        cost: "0.00",
        description:
          "Available to active duty military personnel and dependents, veterans and Gold Star Families with proper identification (CAC Card or DD Form 1173, VHIC, Veteran ID Card or Gold Star Family access voucher).\nThe pass admits the pass owners and any accompanying passengers in a private non-commercial vehicle at per vehicle fee areas, or the pass owner and up to additional 3 adults at sites that charge per person.",
        title: "America the Beautiful Military Pass",
      },
      {
        cost: "0.00",
        description:
        ...
        title: "America the Beautiful Volunteer Pass",
      },
    ],
    directionsInfo:
  ...
  grca: {
    ...
    operatingHours: [
      ...
      },
      {
        ...
        name: "South Rim - Desert View (East Entrance)",
      },
    ],
    weatherInfo:
    ...
    operatingHours: [
      {
        exceptions: [],
        description:
          'Park Grounds and Trails\n\nCheck "Visitor Centers" tab for facility-specific hours',
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
  ...
  grsm: {
    ...
    entrancePasses: [
      {
        cost: "5.00",
        description:
          "Valid parking tags will be required for any vehicles parking in the park starting March 1, 2023. Parking tags will be available for purchase both online and onsite. For more information, visit www.nps.gov/grsm/planyourvisit/fees.htm",
        title: "Daily Parking Tag",
      },
      {
        cost: "15.00",
        description:
          "Valid parking tags will be required for any vehicles parking in the park starting March 1, 2023. Parking tags will be available for purchase both online and onsite. For more information, visit www.nps.gov/grsm/planyourvisit/fees.htm",
        title: "Up to 7 Days Parking Tag",
      },
      {
        cost: "40.00",
        description:
          "Valid parking tags will be required for any vehicles parking in the park starting March 1, 2023. Parking tags will be available for purchase both online and onsite. For more information, visit www.nps.gov/grsm/planyourvisit/fees.htm",
        title: "Annual Parking Tag",
      },
    ],
    directionsInfo:
    ...
    weatherInfo:
      "Elevations in the park range from approximately 875 feet to 6,643 feet and the topography can drastically affect local weather. Temperatures can vary by 10-20 degrees Fahrenheit from mountain base to top, and clear skies lower down do not guarantee equally pleasant weather at higher elevations.",
    ...
    entranceFees: [
      {
        ...
        title:
          "Haleakalā National Park Private Vehicle (14 pax capacity or less) Entry Fee",
      },
      {
        cost: "25.00",
        description:
      ...
      },
      {
        ...
        title:
          "Haleakalā National Park Per Person Entry Fee; includes bicyclists, walk-ins, hikers",
      },
      {
        cost: "30.00",
        description:
        ...
        title:
          "Haleakalā Natonal Park Non-Commercial Organized Groups Fee; Scouts, Rotary, Clubs, Youth Groups, Churches, Reunions",
      },
    ],
    entrancePasses: [
      {
    ...
    entranceFees: [
      {
        ...
        title: "7-Day Park Entrance Pass - Motorcycle Pass",
      },
      {
        cost: "25.00",
        description:
          "Per private family-sized vehicle (valid for 1-7 days from date of purchase).",
        title: "7-Day Park Entrance Pass - Family-Size Vehicle Pass",
      },
      {
        cost: "15.00",
        description:
      ...
      },
      {
        ...
        title: "Commercial Tour Fee - Sedan (1-6 persons)",
      },
      {
        cost: "40.00",
        description: "Entry for commercial vans with 7-15 people.",
        title: "Commercial Tour Fee - Van (7-15 persons)",
      },
      {
        cost: "40.00",
        description: "Entry for commercial mini bus with 16-25 people.",
        title: "Commercial Tour Fee - Mini Bus (16-25 persons)",
      },
      {
        cost: "100.00",
        description: "Entry for commercial motor coaches with 26+ persons.",
        title: "Commercial Tour Fee - Motor Coach (26+ persons)",
      },
    ],
    entrancePasses: [
      {
        ...
        title: "Indiana Dunes National Park Annual Pass",
      },
    ],
    directionsInfo:
    ...
    operatingHours: [
      {
        exceptions: [],
        description:
          "The park and preserve are open 24 hours per day, seven days per week year round. However, visitor services are limited Labor Day through Memorial Day.\n\nSeasonal and temporary closures are listed by location on the Operating Hours & Seasons page.",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
    ...
    entranceFees: [
      {
        cost: "0.00",
        description:
          "Entry to Mammoth Cave National Park and its surface features is free of charge. There is, however, a charge to tour the cave. Cave tour prices vary.",
    ...
    entranceFees: [
      {
        cost: "30.00",
        description:
          "This is a per-vehicle entrance fee for the summer season (May 1 to October 22). It is valid for seven days from the day of purchase.\n\nPlease note that we offer fee waivers for qualified education groups. Visit http://www.nps.gov/meve/learn/education/feewaiver_info.htm to learn more.",
        title: "Mesa Verde Entrance Fee - Per Vehicle - Summer Season",
      },
      {
        cost: "25.00",
        description:
          "This is a per-motorcycle entrance fee for the summer season (May 1 to October 22). It is valid for seven days from the day of purchase.",
        title: "Mesa Verde Entrance Fee - Per Motorcycle - Summer Season",
      },
      {
        cost: "15.00",
        description:
          "This is a per-person (bicyclist and individual) entrance fee for the summer season (May 1 to October 22). It is valid for seven days from the day of purchase.",
        title: "Mesa Verde Entrance Fee - Per Person - Summer Season",
      },
      {
        cost: "20.00",
        description:
          "This is a per-vehicle entrance fee for fall/winter/spring (January 2 to April 30 and October 23 to December 31). It is valid for seven days from the day of purchase.\n\nPlease note that we offer fee waivers for qualified education groups. Visit http://www.nps.gov/meve/learn/education/feewaiver_info.htm to learn more.",
      ...
      },
      {
        cost: "10.00",
        description:
          "This is a per-person (bicyclist and individual) entrance fee for fall/winter/spring (January 2 to April 30 and October 23 to December 31). It is valid for seven days from the day of purchase.",
    ...
    entrancePasses: [
      {
        cost: "55.00",
        description:
          "The annual pass provides entrance into Mesa Verde National Park for a year, beginning from the date of sale. It covers the entrance fee for the pass holder and anyone in their vehicle.",
    ...
    operatingHours: [
      {
        ...
        description:
          "The park is always open, except under emergency conditions. Sites, picnic areas, and most trails are open 8 am to sunset. \n\nMost cliff dwellings can only be visited on a ticketed tour with a ranger. Tours will be offered May 1 through October 22, 2022. Tickets are required and are available online 14 days in advance of tour date. Buy tickets on www.recreation.gov.",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
  ...
  mora: {
    ...
    operatingHours: [
      ...
      },
      {
        ...
        description:
          "In summer, travelers coming from east of the Cascades can enter the park using Chinook Pass (SR410), passing under the Chinook Entrance Arch walking bridge. Entrance open June to mid October, 24 hours a day. No fee station; purchase pass at the next available staffed entrance.",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
    ...
    entrancePasses: [
      {
        cost: "0.00",
        description:
          "Since there are no fees or reservations required, entrance passes are all waived.",
        title: "Entrance Pass",
      },
    ],
    directionsInfo:
    ...
    operatingHours: [
      {
        exceptions: [],
        description:
          "* The National Park of American Samoa is open 24-hours per day, year round, including holidays. However, some areas of the park maybe temporarily closed due to trail maintenance and/or safety measures.\n\n* No fees or reservations are required to visit the national park.\n\n* The visitor center and park store is open during weekdays from 8:00 am to 4:30 pm. closed on weekends and federal holidays.",
        standardHours: {
    ...
    entrancePasses: [
      {
        cost: "0.00",
        description:
          "Since this is not a fee park, park passes, senior passes, and access passes are not available for purchase here. If you plan to visit other national parks with an entrance fee, passes can be purchased online at www.nps.gov, or at any park that charges an entrance fee.",
        title: "Passes",
      },
    ],
    directionsInfo:
    ...
    entranceFees: [
      {
        cost: "0.00",
        description:
          "North Cascades National Park Service Complex does not charge entrance fees.",
    ...
    entrancePasses: [
      {
        cost: "0.00",
        description:
          "North Cascades National Park Service Complex does not sell entrance passes because no entry fee is required to enjoy the park.",
  ...
  pefo: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "150.00",
        description:
          "Large commercial tour bus with capacity of 26 or more: $150 (for 7 days)",
        title: "Large commercial tour bus with capacity of 26 or more",
      },
      {
        cost: "60.00",
        description:
          "Small commercial tour bus with capacity of 16-25: $60 (for 7 days)",
        title: "Small commercial tour bus with capacity of 16-25",
      },
      {
        cost: "50.00",
        description:
          "Commercial tour van with capacity of 7-15: $50 (for 7 days)",
      ...
      },
      {
        cost: "25.00",
        description:
          "Commercial tour passenger vehicle with capacity of 1-6: $25-$50 (for 7 days) depending on occupancy.",
    ...
    operatingHours: [
      {
        ...
        description:
          "Park Road hours of operation. Closed Thanksgiving and Christmas.",
        standardHours: {
          wednesday: "8:00AM - 5:00PM",
          monday: "8:00AM - 5:00PM",
          thursday: "8:00AM - 5:00PM",
  ...
  pinn: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "15.00",
        description:
          "Visitors 16 years and older (i.e. service organizations, scouts, church groups, and college/school clubs) in buses and vehicles with 16 passenger capacity or more.\nValid for 7 days",
    ...
    operatingHours: [
      {
        exceptions: [],
        description:
          "The national and state parks are always open to enjoy. \nRoads, trails and public access remain open year round.\n\nSome campgrounds and visitor centers are closed - or have reduced hours - in the off-season (October-May)",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
  ...
  thro: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "25.00",
        description:
          "Entrance to all units of Theodore Roosevelt National Park for one 1-6 passenger capacity commercial vehicle and its occupants for 7 days. \n\n**Additional fee of $15 per person in addition to the $25 Commercial Vehicle fee.",
  ...
  viis: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "26.00",
        description:
          "Mooring or anchoring overnight (from 5. p.m. to 7 a.m.) \nAnchoring is only available in two locations!",
    ...
    entrancePasses: [
      ...
      },
      {
        cost: "13.00",
        description:
          "Mooring or anchoring overnight for seniors.\nAnchoring is only available in two locations.",
    ...
    operatingHours: [
      {
        ...
        description:
          "Virgin Islands National Park is always open! The Visitor Center and store are currently open from 9:00 a.m. until 1:30 p.m. Monday - Friday. It is closed on weekends, the Fourth of July, Thanksgiving and Christmas.",
        standardHours: {
    ...
    entranceFees: [
      {
        cost: "0.00",
        description:
          "No entrance fees associated with this park.  Camping amenity fees are separate fees.",
    ...
    entrancePasses: [
      {
        cost: "45.00",
        description:
          "This pass is valid for the card holder and three other adults within the same vehicle. Pass is good for one year from month of purchase.",
    ...
    operatingHours: [
      {
        exceptions: [
          {
            ...
            name: "Winter Park Hours - January 29 - March 11",
            endDate: "2023-03-11",
          },
          {
            exceptionHours: {
            ...
            name: "Spring Park Hours - March 12 - April 8",
            endDate: "2023-04-08",
          },
          {
            exceptionHours: {
            ...
            name: "Summer Park Hours - April 9 - September 9",
            endDate: "2023-09-09",
          },
          {
            exceptionHours: {
        ...
        description:
          "Park hours change throughout the year. Gates always open at 7:00 am with closing hours changing with the seasons.",
        standardHours: {
          wednesday: "7:00AM - 6:00PM",
          monday: "7:00AM - 6:00PM",
          thursday: "7:00AM - 6:00PM",
    ...
    operatingHours: [
      {
        exceptions: [],
        description:
          "The park is open all day, every day. Snow or severe weather can limit access to some areas of the park, especially in winter. Visitor Center hours and cave tour schedules vary throughout the year. \n\nVisit the park website or call 605.745.4600 for current conditions.",
        standardHours: {
          wednesday: "All Day",
          monday: "All Day",
          thursday: "All Day",
  ...
  wrst: {
    ...
    directionsUrl:
      "http://www.nps.gov/wrst/planyourvisit/wrangell-st-elias-visitor-center.htm",
    operatingHours: [
      {
        exceptions: [],
        description:
          "The park and public lands are always open but visitor facilities have limited seasons: Open in Summer. Call ahead for hours: Dial-a-Ranger at Slana (907) 822-7401, Copper Center (907) 822-7250, Chitina (907) 823-2205 and Kennecott (907) 205-7106. CLOSED Fall/Winter/Spring - October through April.",
        standardHours: {
          wednesday: "Closed",
          monday: "Closed",
          thursday: "Closed",
  ...
  yose: {
    ...
    entranceFees: [
      ...
      },
      {
        cost: "30.00",
        description:
          "This fee is valid for seven days. Cost is per motorcycle (not per person).",
        title: "Motorcycle",
      },
      {
        cost: "20.00",
      ...
      {
        cost: "25.00",
        description: "The fee is $25 plus $20 per person.",
